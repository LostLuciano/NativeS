...
def create_xcodeproj(project_root):
    ...
    with open(pbxproj_path, "w", encoding="utf-8") as f:
        ...
        f.write("\t\t\t\t\t\"$(inherited)\",\n")
        f.write("\t\t\t\t\t\"$(SRCROOT)/MusicStemNative/DSPFramework/include\",\n")
        f.write("\t\t\t\t);\n")
        ...
        f.write("\t\t\t\t);\n")
        f.write("\t\t\t\tMODULEMAP_FILE = \"$(SRCROOT)/MusicStemNative/DSPFramework/module.modulemap\";\n")
        ...
        f.write("\t\t\t\t\t\"$(SRCROOT)/MusicStemNative/DSPFramework/include\",\n")
        f.write("\t\t\t\t);\n")
        f.write("\t\t\t\tINFOPLIST_FILE = MusicStemNative/Info.plist;\n")
        f.write("\t\t\t\tLD_RUNPATH_SEARCH_PATHS = (\n")
        f.write("\t\t\t\t\t\"$(inherited)\",\n")
        f.write("\t\t\t\t\t\"@executable_path/Frameworks\",\n")
        f.write("\t\t\t\t);\n")
